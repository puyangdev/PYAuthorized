//
//  PYLocationAuthorized.m
//  PYAuthorizedKit
//
//  Created by administrator on 2018/5/8.
//

#import "PYLocationAuthorized.h"
@interface PYLocationAuthorized ()<CLLocationManagerDelegate>
...
@implementation PYLocationAuthorized
+ (instancetype)sharedManager
{
    static PYLocationAuthorized* _sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[PYLocationAuthorized alloc] init];
    });
...
+ (void)authorizeWithCompletion:(void(^)(BOOL granted,BOOL firstTime))completion;
{
    ...
    switch (authorizationStatus) {
        ...
        case kCLAuthorizationStatusNotDetermined:
        {
            ...
            [[PYLocationAuthorized sharedManager] startGps:completion];
        }
            break;
